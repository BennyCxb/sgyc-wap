<template>
  <ul class="mo-paging">
    ...
    <li
      ...
      @click="first"><i class="icon iconfont icon-verticalright"></i>
    </li>

    <!-- prev -->
    <li
      :class="['paging-item', 'paging-item--prev', {'paging-item--disabled' : index === 1}]"
      @click="prev"><i class="icon iconfont icon-left"></i>
    </li>
    ...
    <li
      ...
      @click="next"><i class="icon iconfont icon-right"></i>
    </li>

     <!--last -->
    <li
      :class="['paging-item', 'paging-item--last', {'paging-item--disabled' : index === pages}]"
      @click="last"><i class="icon iconfont icon-verticalleft"></i>
    </li>
